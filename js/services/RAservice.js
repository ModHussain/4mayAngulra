...
//			},
			...
			getskills:function(){
				debugger;
				var deferred = $q.defer();
				$http.get(APIURL+'/ResourceAdda/rest/skills/listSkills').success(function(response){
					deferred.resolve(response);
				}).error(function(err){
					deferred.reject(err);
				})
			...
			searchresource:function(skills,jobcategory,location,experience){
				debugger;
				var deferred = $q.defer();
				$http.get(APIURL+'/ResourceAdda/rest/resource/findResourcesByFilter/'+skills+'/'+jobcategory+'/'+location+'/'+experience+'/1/10').success(function(response){
					deferred.resolve(response);
				}).error(function(err){
					deferred.reject(err);
				})
